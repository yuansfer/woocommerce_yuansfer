...
/**
 * Class that handles Lakala Pay payment method.
 *
 * @extends WC_Gateway_Yuansfer
 *
 */
class WC_Gateway_Yuansfer_Lakalapay extends WC_Yuansfer_Payment_Gateway {

	/**
	 * Constructor
	 */
	public function __construct() {
		$this->id                   = 'yuansfer_lakalapay';
		$this->method_title         = __( 'Yuansfer Lakala Pay', 'woocommerce-yuansfer' );
	...
	public function init_form_fields() {
		$this->form_fields = require( WC_YUANSFER_PLUGIN_PATH . '/includes/admin/yuansfer-lakalapay-settings.php' );
	}
	...
	public function payment_fields() {
		...
		echo '<div
			id="yuansfer-lakalapay-payment-data"
    ...
    public function create_source( $order ) {
        ...
        $post_data['vendor']      = 'enterprisepay';
        $post_data['reference']   = $order_id . ':' . uniqid('enterprisepay:');
        ...
        WC_Yuansfer_Logger::log( 'Info: Begin creating Lakala Pay source' );

        return WC_Yuansfer_API::request( apply_filters( 'wc_yuansfer_lakalapay_source', $post_data, $order ), 'securepay' );
    }
    ...
    public function process_payment( $order_id, $retry = true, $force_save_source = false ) {
        try {
            ...
            WC_Yuansfer_Logger::log( 'Info: Redirecting to Lakala Pay...' );
