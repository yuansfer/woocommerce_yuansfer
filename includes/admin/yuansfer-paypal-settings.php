...
return apply_filters('wc_yuansfer_paypal_settings',
	array(
		'geo_target' => array(
		...
		'enabled' => array(
			...
			'label'       => __('Enable PayPal via Yuansfer', 'woocommerce-yuansfer'),
			'type'        => 'checkbox',
			'description' => '',
			'default'     => 'no',
		),
		'title' => array(
			...
			'default'     => __('PayPal (Yuansfer)', 'woocommerce-yuansfer'),
			'desc_tip'    => true,
		),
		'description' => array(
			...
			'default'     => __('Pay with PayPal via Yuansfer.', 'woocommerce-yuansfer'),
			'desc_tip'    => true,
		),
	)
);
