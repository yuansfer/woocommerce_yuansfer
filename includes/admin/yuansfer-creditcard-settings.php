...
return apply_filters('wc_yuansfer_creditcard_settings',
	array(
		'geo_target' => array(
		...
		'enabled' => array(
			...
			'label'       => __('Enable Credit Card via Yuansfer', 'woocommerce-yuansfer'),
			'type'        => 'checkbox',
			'description' => '',
			'default'     => 'no',
		),
		'title' => array(
			...
			'default'     => __('Credit Card (Yuansfer)', 'woocommerce-yuansfer'),
			'desc_tip'    => true,
		),
		'description' => array(
