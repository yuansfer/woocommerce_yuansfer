 ...
 * Description: Take payments on your store using Yuansfer.
 * Author: FlyingHail
 ...
 * WC tested up to: 3.4
 * Text Domain: woocommerce-yuansfer
...
function woocommerce_yuansfer_missing_wc_notice()
{
    ...
    echo '<div class="error"><p><strong>' . sprintf(esc_html__('Yuansfer requires WooCommerce to be installed and active. You can download %s here.',
    ...
    if (!class_exists('WC_Yuansfer')) :
        ...
        class WC_Yuansfer
        {
            ...
            public function init()
            {
                ...
                require_once __DIR__ . '/includes/payment-methods/class-wc-gateway-yuansfer-lakalapay.php';
            ...
            {
                $plugin_links = array(
                    '<a href="admin.php?page=wc-settings&tab=checkout&section=yuansfer">' . esc_html__('Settings',
                        'woocommerce-yuansfer') . '</a>',
                    '<a href="https://faq.yuansfer.com/">' . esc_html__('Support',
                        'woocommerce-yuansfer') . '</a>',
                );
            ...
            public function add_gateways($methods)
            {
                ...
                $methods[] = 'WC_Gateway_Yuansfer_Lakalapay';
            ...
            public function filter_gateway_order_admin($sections)
            {
                ...
                $sections['yuansfer_lakalapay'] = __('Yuansfer Lakala Pay', 'woocommerce-yuansfer');
